!function (self_name) {
	...
	$ = {
		each: function (a, b) {
			var c, d;
			for (c = 0, d = a.length; c < d; c++) b(a[c], c)
		}, extend: function (a) {
			var b, c, d, e, f = arguments.length;
			for (a = a || {}, c = 1; c < f; c++) if (e = arguments[c], void 0 !== e && null !== e) for (d in e) b = e[d], a !== b && void 0 !== b && (a[d] = b);
			return a
		}
	}, $.extend($, {
		addClass: function (a, b) {
			...
			var a = {}, b = "vglnk_" + (new Date).getTime(), c = 0;
			...
			return $.createEl("a", { href: a, target: b })
			...
			return !!b && $.contains($.attrValues(a, b, d), c)
			...
			var b = document.getElementsByTagName("script")[0],
				c = $.createEl("script", { type: "text/javascript", src: a });
			...
			return document.addEventListener ? c = function () {
				...
				if (!f) {
					...
					if (document.addEventListener) document.addEventListener("DOMContentLoaded", c, !1); else if (document.attachEvent) {
			...
			if ($.hasClass(a, b)) {
				...
				for (c = 0, d = e.length; c < d; c++) e[c] === b && delete e[c];
				a.className = e.join(" ")
			}
			...
			return c = $.extend({
				fn: function () {
				}, "return": !1, timeout: null
			}, c), "string" == typeof c.fn ? b = $.extend(b, { jsonp: c.fn }) : "function" == typeof c.fn && (d = $.destructing(c.fn), e = $.uniqid("vglnk_jsonp_"), b = $.extend(b, { jsonp: e }), window[e] = $.exceptionLogger(function () {
				d.apply(this, arguments), window[e] = void 0
			}), null !== c.timeout && setTimeout($.exceptionLogger(d), c.timeout)), b = $.extend({ format: "jsonp" }, b), b = $.toQuery(b), a = a + (b.length ? "?" : "") + b, c["return"] ? a : $.traits.cors ? $.cors(a) : $.jsonp(a)
		}, toQuery: function (a) {
			var b, c = "";
	...
	viglink = {
		api: function (a, b, c) {
			...
			var a = function (a, b) {
				...
				var b, c = a.previousSibling, d = a.nextSibling, e = ["", a.textContent, ""],
					f = 10, g = function (a, b, c) {
						var d = function (a) {
			...
			return function (d, e) {
				...
				if (g = this.clickParams(d, i), this.logTime(), opts.log_context && c(d), "go" === i) this.redirect(this.api("click", g, { "return": !0 }), h, e); else if (h === window.self) this.api("click", g, {
					fn: f,
			...
			return function (b, c) {
				b = b.toLowerCase();
				var d = a[b] || { fired: !1, listeners: [] }, e = function (a) {
					a({ type: b })
				};
			...
			if (opts.rewrite_modified && a && b) switch (b) {
				case"setup":
					$.cache(a, "href") || $.cache(a, "href", a.href), a.href = this.api("click", this.clickParams(a, "go"), { "return": !0 }), setTimeout($.exceptionLogger($.bind(function () {
			...
			return $.harmony = { UNSAFE_QUIRKSMODE_HANDLERS: 1 }, function (a) {
			...
			self = scope[self_name] = function () {
			}, this.expose("click"), this.expose("link", viglink.preprocessLink), this.expose("opt"), this.expose("$", $.clone($)), $.extend(self, self === window.vglnk ? b : {})
		}, initDRApi: function () {
			var a = !1;
			...
			var a, b = window, c = self_name.split(".");
			...
			this.initLegacyOptions(), opts = $.extend(this.publicOptions({
				...
				nofollow: {},
				norewrite: {},
				plugins: { link_affiliation: {}, modified_clicks: {} },
				swap: {},
				time_click: !1,
				time_ping: !1
			});
			...
			var a, b = {
				vl_cB: $.bind(this.onApiClick, this), vl_disable: function () {
					opts.enabled = !1
				}
			};
			...
			var a, b = 100, c = 5e3, d = 1, e = [], f = function () {
				var g = [], h = function (a) {
					return function () {
						if (a) {
			...
			$.on(a, "mousedown", function (a) {
				a = a || window.event;
				var b = $.eventLink(a);
				b && !$.cache(b, "evented") && ($.on(b, "click", function (a) {
				}), $.cache(b, "evented", !0))
			...
			var e, f, g = $.toQuery({ nocache: $.uniqid() }), h = "pixel.gif";
			if ("custom" === a) f = b, a = c, g += "&" + $.toQuery({
				...
				if (g += "&" + $.toQuery({
					...
					time: c,
					type: b
				}; else if ("exception" === a) e = { e: b, o: c }; else {
					if ("info" !== a) return;
					e = { i: b }
				}
				g += "&" + $.toQuery(e)
			...
			var f, g = d || a.href, h = $.bind(function () {
				this.redirect(g, b, c)
			}, this);
			"object" == typeof e && (e.tracking || e.image) ? (f = $.createEl(e.tracking ? "iframe" : "img", { src: e.tracking || e.image }, {
				height: 0,
				width: 0,
				visibility: "hidden"
			...
			var b = a.ctrlKey || a.metaKey || a.altKey || a.shiftKey,
				c = a.which && 1 === a.which || 0 === a.button, d = $.eventLink(a);
			...
			var a = !1;
			return function () {
				a || !opts.key && !opts.dr_key || (a = !0, this.logTime(), this.api("ping", null, { fn: $.bind(this.onApiPing, this) }))
			}
